      ...
      <div style={{maxWidth:760,margin:"0 auto"}}>
        ...
        <div style={{background:"white",borderRadius:28,padding:"clamp(22px,5vw,34px)",marginTop:18,boxShadow:"0 18px 50px rgba(0,0,0,.08)"}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:18,marginTop:18,flexWrap:"wrap"}}>
            ...
            <div><h1 style={{margin:0,fontSize:"clamp(34px,8vw,46px)",color:"#101a38"}}>Alex Morgan</h1><p style={{color:"#667085",margin:"7px 0"}}>Handyman · Pittsburgh, PA</p><span style={{background:"#ecfdf3",color:"#15803d",padding:"6px 11px",borderRadius:999,fontWeight:700}}>● Available now</span></div>
          </div>
