...
import { SEARCH_VOCABULARY, normalizeSearch, queryRequestsMobile, queryRequestsRemote } from "./searchVocabulary";
...
export default function SearchVocabularyBridge() {
  useEffect(() => {
    ...
    const applyCanonicalSearch = () => {
      ...
      const wantsMobile = queryRequestsMobile(original);
      const canonical = wantsMobile ? null : rankedServices(original)[0]?.name || null;
