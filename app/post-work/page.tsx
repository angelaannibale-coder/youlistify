...
export default function PostWorkPage() {
  ...
  const locationChoices=[{value:"local",label:"Local only"},{value:"remote",label:"Remote only"},{value:"both",label:"Local and remote"}] as const;
