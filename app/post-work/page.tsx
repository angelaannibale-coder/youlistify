...
export default function PostWorkPage() {
  ...
  const locationChoices=[{value:"local",label:"Local only",hint:"Tied to this city"},{value:"remote",label:"Remote only",hint:"Can be done from anywhere"},{value:"both",label:"Local and remote",hint:"Good when either option works"}] as const;
