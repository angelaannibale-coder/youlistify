...
<a className="brand brand-preview-logo" href="#top" aria-label="YouListify home"><img className="brand-preview-logo-image" src="/youlistify-logo-preview.png" alt="YouListify" /></a>
