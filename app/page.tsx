...
<a className="brand" href="#top" aria-label="YouListify home"><span className="brand-icon">Y</span><span className="brand-word"><span>You</span><span className="capital-l">L</span><span>istify</span></span></a>
...
<label style={{ position: "relative" }}><span>WHAT DO YOU NEED?</span><div className="input-shell"><b>⌕</b><input value={service} onChange={(e) => {setService(e.target.value);setShowServiceSuggestions(true);}} onFocus={() => setShowServiceSuggestions(true)} placeholder="Handyman, DJ, cleaner..." /></div>
...
<label style={{ position: "relative" }}><span>WHERE?</span><div className="input-shell" style={{ position: "relative" }}><b>✦</b><input value={location} onChange={(e)=>{setLocation(e.target.value);setShowLocationSuggestions(true);}} onFocus={()=>setShowLocationSuggestions(true)} placeholder="City or ZIP code" /></div>
...
<footer><a className="brand" href="#top"><span className="brand-icon">Y</span><span className="brand-word"><span>You</span><span className="capital-l">L</span><span>istify</span></span></a><p>Find the right person. Call them in minutes. Get the job done.</p><small>© {new Date().getFullYear()} YouListify. All rights reserved.</small></footer>
