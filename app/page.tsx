...
<a className="brand" href="#top" aria-label="YouListify home"><span className="brand-icon" aria-hidden="true"><img src="/path-sun-logo.svg" alt="" /></span><span className="brand-word"><span>You</span><span className="capital-l">L</span><span>istify</span></span></a>
